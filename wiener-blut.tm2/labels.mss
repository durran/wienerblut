...
#poi_label[network='u-bahn'][maki='rail-metro'][scalerank=1][zoom>=10],
#poi_label[network='u-bahn'][maki='rail-metro'][scalerank=2][zoom>=10],
#poi_label[network='u-bahn'][maki='rail-metro'][scalerank=3][zoom>=10] {
